...
type DemoAction = 'catalog' | 'projects' | 'all' | null
          ...
          ? {
              ...
              description: (
                <>
                  ...
                  the entire catalog, and all projects from localStorage, then reloads the page.
                  You will be signed out and every demo change will be permanently lost. This
    ...
    <>
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <div className="rounded-lg border-[0.5px] border-red-200 bg-red-50/40 p-4">
          ...
          <p className="mb-4 text-[11px] leading-relaxed text-stone-600">
            Wipe auth, catalog, and projects from localStorage and reload the app. Use this for a
            completely fresh demo environment. This cannot be undone.
          </p>
          <Button
            type="button"
            variant="destructive"
